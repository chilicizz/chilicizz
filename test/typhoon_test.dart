...
void main() {
  group('Typhoon unit tests', () {
    test('testParseTyphoonData', () async {
      ...
      expect(fileContents.isNotEmpty, true, reason: "Test file should not be empty");
      ...
      expect(typhoons[0].englishName, 'SURIGAE', reason: "Name not parsed correctly");
      expect(typhoons[0].chineseName, '舒力基', reason: "Chinese name not parsed correctly");
      expect(
          typhoons[0].url.trim(), 'https://www.weather.gov.hk/wxinfo/currwx/hko_tctrack_2102.xml',
    ...
    test('testParseTyphoonTrack', () async {
      ...
      expect(typhoonTrack?.bulletin != null, true, reason: "Should load track bulletin data");
      expect(typhoonTrack?.current != null, true, reason: "Should load current status");
